# AutotileFill - manual plugin installer for GameMaker LTS 2026, for
# people who don't want to use GMPM. Run from this folder (build\), which
# has the .dll/.gmplugin sitting right next to this script.
